...
\begin{document}
  \begin{tikzpicture}[
    ...
    \node[rounded corners=4pt, draw=black!30, fill=black!4,
          ...
          text=lrLabel] (prob) at (1.1,-0.05) {PROBLEM};

    % ---------- explicit lane (top) ----------
    \node[title, text=lrGray] at (4.1,3.35) {Explicit Chain of Thought};
    \node[sub]                at (4.1,2.75) {discrete text, fixed budget};
    ...
    % ---------- latent lane (bottom) ----------
    \node[title, text=lrBlueDk] at (4.1,-0.15) {Latent reasoning};
    \node[sub]                  at (4.1,-0.75) {continuous vectors, adaptive budget};
