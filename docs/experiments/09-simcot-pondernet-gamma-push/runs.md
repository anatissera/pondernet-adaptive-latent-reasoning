...
> **Baseline (exp-08 Run B ep5, γ=0.10, α=1.0, β=1.5):**
> thr0.3 → 40.0% @ 2.55 · thr0.4 → 40.6% @ 3.10 · thr0.5 → 41.0% @ 3.64 · thr0.8 → 41.2% @ 6.23.
> Target: match or exceed accuracy at fewer steps.
