...
| 07 | [simcot-pondernet-fullscope-prior](experiments/07-simcot-pondernet-fullscope-prior/experiment.md) | full backbone unfreeze (Recipe C) + per-instance adaptive prior + K_max=12 | 40.26% @ thr0.8 ep5; Spearman **0.684** (project record, ep3) | complete |
