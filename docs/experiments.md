...
| 06 | [simcot-pondernet-trunc-k](experiments/06-simcot-pondernet-trunc-k/experiment.md) | per-instance truncated-K training (K_i=n_i) to break K=6 warm-start bias | — | active |
